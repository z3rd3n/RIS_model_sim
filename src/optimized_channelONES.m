...
%     hold_SO(ii) = -C_SO;
    ...
    [F_PS, C_PS] = particleswarm(@channel_calculateVAR,N,lb_PS,ub);
    hold_PS(ii) = -C_PS;
    
%     [F_GA, C_GA] = ga(@channel_calculateVAR,N,[],[],[],[],lb_PS,ub);
%     hold_GA(ii) = -C_GA;
    
    hold_ideal(ii) = -channel_calculateONES();
